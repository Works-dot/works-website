    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col md:flex-row md:items-center gap-4">
        <p className="text-sm leading-relaxed text-works-light/90 md:flex-1">
          Weboldalunk működéséhez nem használunk követő sütiket. A Kapcsolat
          oldalon beágyazott Google Térkép azonban a betöltésekor a Google
          sütijeit használhatja — ehhez kérjük a hozzájárulásod. Részletek a{" "}
          <Link
            href="/sutik"
